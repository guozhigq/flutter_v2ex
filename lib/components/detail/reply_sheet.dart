...
class _ReplySheetState extends State<ReplySheet> with TickerProviderStateMixin{
  ...
  void initState() {
    ...
    _tabController = TabController(length: widget.replyMemberList.length, vsync: this);
  }
  @override
          ...
          Expanded(
            child: Container(
              ...
              child: ListView.builder(
                ...
                itemCount: widget.resultList[0][widget.replyMemberList[0]].length,
                itemBuilder: (BuildContext context, int index) {
                  return ReplyListItem(
                    reply: widget.resultList[0][widget.replyMemberList[0]][index],
