...
class Strings {
  ...
  /// 提交tag时 记得更改
  static String currentVersion = 'v1.2.10';
  ...
  static Map<String, String> coolapkEmoticon = {
    "k_doge": "$emojiBaseUrl/coolapk/coolapk_emotion_37_doge.png",
    "k_\u4e8c\u54c8": "$emojiBaseUrl/coolapk/coolapk_emotion_59_erha.png",
    "k_\u4eb2\u4eb2": "$emojiBaseUrl/coolapk/coolapk_emotion_20_qinqin.png",
    "k_\u5047\u54ed": "$emojiBaseUrl/coolapk/coolapk_emotion_1019.png",
    "k_\u5047\u7b11": "$emojiBaseUrl/coolapk/coolapk_emotion_1020.png",
    "k_\u518d\u89c1": "$emojiBaseUrl/coolapk/coolapk_emotion_25_zaijian.png",
    "k_\u53d8\u6001\u6ed1\u7a3d":
        "$emojiBaseUrl/coolapk/coolapk_emotion_65_coshuaji.png",
    "k_\u53ef\u601c": "$emojiBaseUrl/coolapk/coolapk_emotion_26_kelian.png",
    "k_\u5403\u74dc": "$emojiBaseUrl/coolapk/d_1.png",
    "k_\u5410\u8840": "$emojiBaseUrl/coolapk/coolapk_emotion_21_penxue.png",
    "k_\u5428\u5428\u5428":
        "$emojiBaseUrl/coolapk/coolapk_emotion_52_hejiu.png",
    "k_\u5472\u7259": "$emojiBaseUrl/coolapk/coolapk_emotion_3_ciya.png",
    "k_\u54c8\u54c8": "$emojiBaseUrl/coolapk/coolapk_emotion_1_hahaha.png",
    "k_\u54ed\u4e86": "$emojiBaseUrl/coolapk/coolapk_emotion_33_wulian.png",
    "k_\u559c": "$emojiBaseUrl/coolapk/f_xi.png",
    "k_\u55b7": "$emojiBaseUrl/coolapk/coolapk_emotion_44_pen.png",
    "k_\u8d5e": "$emojiBaseUrl/coolapk/coolapk_emotion_27_qiang.png",
    "k_\u65e0\u8bed": "$emojiBaseUrl/coolapk/coolapk_emotion_18_han.png",
    "k_\u673a\u667a": "$emojiBaseUrl/coolapk/coolapk_emotion_34_jizhi.png",
    "k_\u7eff\u8272": "$emojiBaseUrl/coolapk/coolapk_emotion_61_lvmao.png",
    "k_\u5e76\u4e0d\u7b80\u5355": "$emojiBaseUrl/coolapk/d_bingbujiandan.png",
